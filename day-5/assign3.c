// Write a C program that reads an integer array of size 10 from a binary file named "data.bin"
// using the fread function. Calculate and display the sum of all the elements in the array.
